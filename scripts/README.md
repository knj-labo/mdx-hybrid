...
- `compare-astro-harness.mjs` — build baseline/markflow harness and record timings to `fixtures/integration/astro-harness/harness-summary.json` (build-only, no diff)。
