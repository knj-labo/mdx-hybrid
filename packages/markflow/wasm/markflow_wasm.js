 ...
 * @param {string} input
 * @param {boolean | null} [enforce_img_loading_lazy]
 * @param {boolean | null} [enable_directives]
 * @param {boolean | null} [enable_hoist]
 * @param {boolean | null} [enable_smartypants]
 * @param {boolean | null} [enable_components]
 * @returns {string}
 */
export function render_html(input, enforce_img_loading_lazy, enable_directives, enable_hoist, enable_smartypants, enable_components) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.render_html(ptr0, len0, isLikeNone(enforce_img_loading_lazy) ? 0xFFFFFF : enforce_img_loading_lazy ? 1 : 0, isLikeNone(enable_directives) ? 0xFFFFFF : enable_directives ? 1 : 0, isLikeNone(enable_hoist) ? 0xFFFFFF : enable_hoist ? 1 : 0, isLikeNone(enable_smartypants) ? 0xFFFFFF : enable_smartypants ? 1 : 0, isLikeNone(enable_components) ? 0xFFFFFF : enable_components ? 1 : 0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @param {boolean | null} [enable_components]
 */
export function stream_html(input, chunk_callback, enforce_img_loading_lazy, enable_directives, enable_hoist, enable_smartypants, enable_components) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.stream_html(ptr0, len0, chunk_callback, isLikeNone(enforce_img_loading_lazy) ? 0xFFFFFF : enforce_img_loading_lazy ? 1 : 0, isLikeNone(enable_directives) ? 0xFFFFFF : enable_directives ? 1 : 0, isLikeNone(enable_hoist) ? 0xFFFFFF : enable_hoist ? 1 : 0, isLikeNone(enable_smartypants) ? 0xFFFFFF : enable_smartypants ? 1 : 0, isLikeNone(enable_components) ? 0xFFFFFF : enable_components ? 1 : 0);
    if (ret[1]) {
 ...
 * @returns {any}
 */
export function parse_blocks(input, opts) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_blocks(ptr0, len0, opts);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function compile(source, filepath) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(filepath, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('markflow_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
